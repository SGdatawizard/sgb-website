...
export default function Home() {
  ...
  return (
    <div style={{ background: '#f5f5f3', minHeight: '100vh' }}>
      ...
      {/* My Collection */}
      <a href="/account" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', height: '220px', textDecoration: 'none' }}>
      ...
      {/* SGB 100 */}
      <a href="/sgb100" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', height: '220px', textDecoration: 'none' }}>
